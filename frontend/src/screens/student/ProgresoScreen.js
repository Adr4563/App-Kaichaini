            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text
                  ...
                  numberOfLines={2}
                >
                  {item.ejercicio?.enunciado || 'Ejercicio'}
                </Text>
                <Text style={{ fontSize: 11, color: '#888' }}>
                  {formatFecha(item.fechaRespuesta)}
                  {item.ejercicio?.tipo ? ` · ${formatTipo(item.ejercicio.tipo)}` : ''}
                </Text>
              </View>
          ...
          >
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={{ fontSize: 12, color: '#888', marginBottom: 22 }}>
                {formatTipo(seleccionado?.ejercicio?.tipo)} · {formatFecha(seleccionado?.fechaRespuesta)}
              </Text>
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 14, color: '#1a1a1a', lineHeight: 20 }}>
                  {seleccionado?.ejercicio?.enunciado || '—'}
                </Text>
              </View>
